export interface HtmlBrowserRuntimeProof {
  ...
  readonly runtimeProofCapsule?: unknown;
  readonly runtimeProofMode?: string;
  readonly runtimeProofCapsuleHash?: string;
  readonly runtimeBrowserName?: string;
  readonly runtimeBrowserVersion?: string;
  readonly runtimeViewport?: Readonly<Record<string, unknown>>;
  readonly runtimeTelemetryHash?: string;
  readonly runtimeDomSnapshotHash?: string;
  readonly runtimeComputedStyleHash?: string;
  readonly runtimeLayoutSnapshotHash?: string;
  readonly runtimeEventTraceHash?: string;
  readonly runtimeAccessibilitySnapshotHash?: string;
  readonly runtimeFocusSnapshotHash?: string;
  readonly runtimeLayoutShiftHash?: string;
  readonly runtimeScreenshotHash?: string;
  readonly runtimeCumulativeLayoutShift?: number;
